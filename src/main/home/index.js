...
const PromotionContent = () => (
    <p className="home-promotion-content">
        ...
        ฉีดเติมเต็มกลับเข้าไปสู่บริเวณใบหน้าหรือเติมเต็มสัดส่วน
        ต่างๆในร่างกาย
...
const PromotionHeader = () => (
    <Header style={{
        zIndex: 1, position: 'relative', fontSize: 64, fontFamily: 'ButlerRegular',
    }}
    >
Promotion
    </Header>
...
const Home = () => (
    <Grid>
        <Row style={gridStyle}>
            <Image src="/static/images/home/banner-background.png" fluid />
