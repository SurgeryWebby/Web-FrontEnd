...
export default ({ title, imagePath }) => {
    const BannerContentStyled = {
        ...
        backgroundImage: `url(${imagePath || '/static/images/faqs/banner.png'} ) !important`,
    ...
    return (
        <Segment style={BannerContentStyled} vertical>
            <Rail size="massive" internal position="left" style={{}}>
                <Segment
                    vertical
                    style={{
                        padding: 0, borderBottom: 0, position: 'absolute', left: '10vw', bottom: 0, width: 400, zIndex: 2,
                    }}
                >
